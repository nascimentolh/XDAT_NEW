...
if defined JAVA_FX_HOME (
    if exist "%JAVA_FX_HOME%\bin\java.exe" (
        ...
        "%JAVA_FX_HOME%\bin\java.exe" -jar xdat-editor-1.4.1.jar %*
        goto :eof
    ) else (
...
java --add-modules javafx.controls,javafx.fxml,javafx.graphics,javafx.swing -jar xdat-editor-1.4.1.jar %* 2>nul
...
if exist "%JAVAFX_PATH%\javafx.controls.jar" (
    ...
    java --module-path "%JAVAFX_PATH%" --add-modules javafx.controls,javafx.fxml,javafx.graphics,javafx.swing -jar xdat-editor-1.4.1.jar %*
) else (
    echo.
    echo ============================================================
